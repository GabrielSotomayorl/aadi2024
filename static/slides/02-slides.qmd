...
**Media:** Suma de las puntuaciones dividida por el número de observaciones. Sensible
a los casos extremos.
$$
\bar{x} = \frac{1}{n} \sum_{i=1}^{n} x_i
$$
**Varianza:** es el promedio de las distancias de los casos al promedio, tomando en
cuenta los signos (eleva al cuadrado todas las distancias al promediarlas)
