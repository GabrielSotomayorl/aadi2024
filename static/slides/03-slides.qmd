...
**Ordenada en el origen 𝑎:** Representa el valor predicho de𝑦cuando 𝑥= 0. Sólo tiene significado estadístico cuando x toma valores cercanos
a 0.
...
**Conexión entre correlación y regresión**:
  - La pendiente de la recta de regresión mínimo-cuadrática se calcula como:
