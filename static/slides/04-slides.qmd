...
**¿Qué es $R^2$?**
- **$R^2$**, conocido como el coeficiente de determinación, es una medida estadística que indica la proporción de la varianza en la variable dependiente $Y$ que es explicada por la variable independiente $X$ en un modelo de regresión.
...
- Un $R^2$ de 0.85 indica que el 85% de la varianza en $Y$ es explicada por $X$, mientras que el 15% restante es debido a factores no capturados por el modelo (varianza residual).  

## Observacions atípicas y observaciones influyentes en regresión {.smaller background-color="white"}

- Una observación **atípica** es aquélla que queda separada de las restantes
observaciones.  
