...
- **Intercepto (0.22)**: Los odds de encontrarse en situación de pobreza son 0.22 cuando el jefe de hogar es hombre y tiene una edad de referencia (edad igual a 0).
- **Mujer (ref. hombre, 1.12)**: Los odds de estar en situación de pobreza son 1.12 veces mayores en los hogares con jefatura femenina, comparado con los hogares con jefatura masculina, manteniendo constante la edad. Esto indica que las mujeres jefas de hogar tienen una mayor probabilidad de encontrarse en situación de pobreza.
- **Edad (0.98)**: Por cada año adicional de edad del jefe de hogar, los odds de encontrarse en situación de pobreza disminuyen un 2%, manteniendo constante el sexo del jefe de hogar.
...
1. **Valor mayor a 1**: Si el odds ratio es mayor a 1, significa que el grupo comparado tiene una mayor probabilidad del evento estudiado en comparación con el grupo de referencia. Por ejemplo, un odds ratio de 1.12 indica que la probabilidad del evento es un 12% mayor en el grupo comparado, manteniendo constantes las demás variables. Esto implica que el grupo comparado tiene un mayor riesgo o probabilidad del evento en relación con el grupo de referencia.

2. **Valor menor a 1**: Si el odds ratio es menor a 1, indica que el grupo comparado tiene una menor probabilidad del evento estudiado en comparación con el grupo de referencia. Esto implica un efecto protector o una reducción de la probabilidad del evento para el grupo comparado.
...
1. **Valor mayor a 1**: Si el odds ratio es mayor a 1, significa que por cada unidad adicional de la variable continua, la probabilidad del evento estudiado aumenta. Esto implica que la variable tiene un efecto positivo en la probabilidad del evento. Un valor mayor que 1 sugiere un incremento proporcional en los odds del evento.

2. **Valor menor a 1**: Si el odds ratio es menor a 1, indica que por cada unidad adicional de la variable continua, la probabilidad del evento disminuye. Por ejemplo, un odds ratio de 0.98 implica que, por cada año adicional de edad del jefe de hogar, los odds de estar en situación de pobreza disminuyen en un 2%. Un valor menor que 1 indica un efecto protector o una reducción en los odds del evento conforme aumenta la variable.
...
- **Coeficiente de Comparación de Grupos**: Este tipo de coeficiente se utiliza para variables categóricas, donde se compara un grupo específico con un grupo de referencia. Por ejemplo, en el caso de la variable **sexo** del jefe de hogar, el coeficiente de **Mujer (ref. hombre, 1.12)** representa la comparación entre los hogares con jefatura femenina y aquellos con jefatura masculina. En este caso, el odds ratio de 1.12 indica que los hogares con jefatura femenina tienen un 12% más de probabilidad de encontrarse en situación de pobreza comparado con los hogares con jefatura masculina, manteniendo constante la edad. Los coeficientes de comparación de grupos siempre se interpretan en relación con una categoría de referencia.

## Diferencia entre un Coeficiente de Comparación de Grupos y uno de una Variable Continua {.smaller background-color="white"}


- **Coeficiente de una Variable Continua**: Este tipo de coeficiente se utiliza para variables numéricas que pueden tomar un rango de valores, como la **edad** del jefe de hogar. En este caso, el coeficiente de **Edad (0.98)** indica el cambio en los odds de encontrarse en situación de pobreza por cada año adicional de edad del jefe de hogar, manteniendo constante el sexo. Un odds ratio de 0.98 significa que, por cada año adicional de edad, los odds de estar en situación de pobreza disminuyen en un 2%. A diferencia de los coeficientes de comparación de grupos, los coeficientes de variables continuas reflejan un cambio incremental en los odds del evento por cada unidad adicional de la variable independiente.
