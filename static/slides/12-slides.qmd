...
## Tipos de técnicas multivariadas {.smaller background-color="white"}
...
4.  **Decisión sobre el Número de Conglomerados**:
    -   Determinar el número de conglomerados que se constituirán, basado en criterios estadísticos, visualizaciones (como dendrogramas) o criterios teóricos.

## Pasos Principales en el Análisis de Conglomerados {.smaller background-color="white"}

5.  **Presentación e Interpretación de Resultados**:
    -   Presentar e interpretar los resultados obtenidos, tanto en su forma numérica (tablas de aglomeración) como gráfica (dendrogramas y gráficos de témpanos).
...
## Obtención de conglomerados {.smaller background-color="white"}
...
-   **Dendrograma**: Además, la información proporcionada por el dendrograma es uno de los gráficos más característicos en la conglomeración y puede ser útil para la determinación del número de conglomerados
